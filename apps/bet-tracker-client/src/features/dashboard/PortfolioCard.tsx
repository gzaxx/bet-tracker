...
import { Button, Card, Group, Menu, Stack, Text, TextInput, ThemeIcon, UnstyledButton } from '@mantine/core'
import { IconChevronRight, IconSettings, IconTrash, IconWallet } from '@tabler/icons-react'
...
export const PortfolioCard = ({ portfolio, onDelete, onSelect, selected }: PortfolioCardProps) => {
